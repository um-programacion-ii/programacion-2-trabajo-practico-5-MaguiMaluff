...
class ProyectoServiceImplTest {
    ...
    void testBuscarPorFechaFinAntes_ConProyectos() {
        ...
        when(proyectoRepository.findByFechaFinaBefore(fecha)).thenReturn(Arrays.asList(p1, p2));
    ...
    void testBuscarPorFechaFinAntes_SinProyectos() {
        ...
        when(proyectoRepository.findByFechaFinaBefore(fecha)).thenReturn(Collections.emptyList());
